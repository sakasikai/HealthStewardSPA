        ...
        <q-card-section horizontal>
          <q-card-section class="q-gutter-lg">
            ...
            <q-card horizontal class="row no-wrap">
              ...
              <q-input v-show="!isEdit" class="q-px-md my-input-width" readonly v-model="ageInput" />
              <q-input
                v-show="isEdit"
                borderless
                class="q-px-md q-pb-none my-input-width"
            ...
            <q-card horizontal class="row no-wrap">
              <q-card-section class="col-4 bg-grey-2">身高</q-card-section>
              <q-input
                v-show="!isEdit"
                class="q-px-md my-input-width"
                readonly
            ...
            <q-card horizontal class="row no-wrap">
              <q-card-section class="col-4 bg-grey-2">体重</q-card-section>
              <q-input
                v-show="!isEdit"
                class="q-px-md my-input-width"
                readonly
            ...
            <q-card horizontal class="row no-wrap">
              <q-card-section class="col-4 bg-grey-2">血型</q-card-section>
              <q-input
                v-show="!isEdit"
                class="q-px-md my-input-width"
                readonly
            ...
            <q-card horizontal class="row no-wrap">
              <q-card-section class="col-4 bg-grey-2">出生日期</q-card-section>
              <q-input
                v-show="!isEdit"
                class="q-px-md my-input-width"
                readonly
          ...
          <q-card-section class="q-gutter-lg">
            <div class="row no-wrap items-center q-mt-none" style="height: 180px">
              <div class="q-gutter-lg q-mr-md">
                <q-card horizontal class="row no-wrap">
                  ...
                  <q-input
                    ...
                    readonly
                  >
                    <q-tooltip v-show="true">您不可编辑该项</q-tooltip>
                  </q-input>
                </q-card>
              ...
              <q-avatar size="100px" v-show="!isEdit">
                <q-img
                  :src="imagePreviewUrl"
                  height="100px"
                  width="100px"
            ...
            <q-card horizontal class="row no-wrap q-mt-sm">
              <q-card-section class="col-4 bg-grey-2">档案号</q-card-section>
              <q-input
                v-show="!isEdit"
                class="q-px-md q-pb-none my-input-width"
            ...
            <q-card horizontal class="row no-wrap">
              <q-card-section class="col-4 bg-grey-2">身份证号</q-card-section>
              <q-input
                v-show="!isEdit"
                class="q-px-md q-pb-none my-input-width"
            ...
            <q-card horizontal class="row no-wrap">
              <q-card-section class="col-4 bg-grey-2">老人类型</q-card-section>
              <q-input
                v-show="!isEdit"
                class="q-px-md q-pb-none my-input-width"
                v-model="typeInput"
            ...
            <q-card horizontal class="row no-wrap">
              <q-card-section class="col-4 bg-grey-2">备注</q-card-section>
              <q-input
                v-show="!isEdit"
                class="q-px-md q-pb-none my-input-width"
                v-model="remarkInput"
  ...
  methods: {
    ...
    onSubmit() {
      ...
      const data = {
        ...
        type: this.typeInput,
        phone: this.phoneNumber(this.phoneInput),
    ...
    loadClientInfo() {
      this.$axios
        .get("api/client/"+ this.userInfo.userName+"/get/clientInfo")
        .then(res => {
          ...
          if (!!this.clientInfo.phone) {
            this.phoneInput =
              this.clientInfo.phone.toString().substring(0, 3) +
              " " +
              this.clientInfo.phone.toString().substring(3, 7) +
              " " +
              this.clientInfo.phone.toString().substring(7);
          }
        })
        .catch(e => {
          this.$q.notify({
